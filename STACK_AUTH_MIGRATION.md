...
1. **Créer un compte sur Stack Auth** (si ce n'est pas déjà fait)
   ...
   - Créer un nouveau projet ou utiliser le projet existant (ID: `dd6e2f80-b3da-4d4b-85f9-9cf7f443ab97`)
...
NEXT_PUBLIC_STACK_PROJECT_ID='dd6e2f80-b3da-4d4b-85f9-9cf7f443ab97'
