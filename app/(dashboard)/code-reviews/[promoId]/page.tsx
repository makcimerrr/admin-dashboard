...
import { ArrowLeft, ClipboardCheck, Users, BarChart3 } from 'lucide-react';
import {
...
async function PromoContent({ promoId }: { promoId: string }) {
  // 🔥 Appel API au lieu d'appel direct fonction
    ...
    for (const projectName of projectNames) {
      ...
      for (const group of groups) {
        ...
        if (audit) {
          ...
          const memberWarnings = audit.results.reduce(
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-xs text-muted-foreground">
                      ...
                      <span>
                        {trackStats.total - trackStats.audited} en attente
                      </span>
                    </div>
                  </div>
                </CardContent>
